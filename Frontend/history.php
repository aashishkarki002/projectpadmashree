...
<body>
    ...
    function deleteTransaction(transactionId, transactionType) {
        ...
        fetch('/projectpadmashree/backend/delete_transaction.php', {
            ...
            body: JSON.stringify({ transaction_id: transactionId, transaction_type: transactionType })
        })
    ...
    try {
        ...
        if (data.status === 'success') {
            ...
            if (data.data.transactions.length === 0) {
                tableBody.innerHTML = '<tr><td colspan="4" class="text-center text-gray-500">No transactions found.</td></tr>';
            } else {
